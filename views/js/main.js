/*
Welcome to the 60fps project! Built into the code, you'll find a few instances of the User Timing API
   ...
   function changePizzaSizes(size) {
     switch(size) {
       ...
       case "3":
         ...
         break;
       default:
         console.log("Bug in Changing the pizzaSizes");
     }

     var randomPizzas = document.querySelector('.randomPizzaContainer');
     var numPizzas = randomPizzas.length;
